...
const EmployerSecurity: React.FC = () => {
    ...
    <DashboardLayout menuItems={employerMenu} role="employer">
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          {!showPasswordForm ? (
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-600">Last changed 3 months ago</p>
              </div>
              <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-slate-600">Add an extra layer of security</p>
              <p className="text-sm text-slate-500">Requires a code from your phone to sign in</p>
            </div>
